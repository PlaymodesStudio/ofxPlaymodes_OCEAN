...
//
//        addParameter(paramConnect.set("Connect"));
//        addParameter(device.set("Device", 0, 0, ps3eye::PS3EYECam::getDevices().size()-1));
//        addParameter(paramExposure.set("Exposure",255,0,255));
//        addParameter(paramHue.set("Hue",127,0,255));
//        addParameter(paramAutoGain.set("AutoGrain",false));
//        addParameter(paramAutoWB.set("AutoWB",false));
